...
import SocialContact from '../../components/blog/detail/SocialContact'
import ReadNext from '../../components/blog/detail/ReadNext'
import $ from 'jquery'

const BlogDetail = props => {
  const category = props.match.params.category;
  const courseAd = 'https://via.placeholder.com/400x300.png?text=' + category;
  ...
  const handleScroll = () => {
    ...
    $("#scroll-indicator").width(scrolled + "%");
    console.log($("#scroll-indicator").width())
  }
  useEffect(() => {
    let top = $('.navbar2').height() + 60;
    $('.blog-side-menu').height($('.detail-article').height())
  ...
  return (
    <div className="blog-detail">
      ...
      <div className="row row-eq-height mb-5 align-items-start">
        <div className="col-8 detail-article">
            <div className="social-contact"><SocialContact/></div>
            ...
            <div className="social-contact mt-3 mb-5"><SocialContact/></div>
            <ReadNext/>
        </div>
        <div className="col-4 blog-side-menu">
          <nav className="sticky-top sticky-part">
            ...
            <div className="course-ad blog-side-menu-section">
              <img src={courseAd} alt="Course Advertisement" />
            </div>
            <NewestArticles/>
            <HighlightArticles/>
            <Tag/>
